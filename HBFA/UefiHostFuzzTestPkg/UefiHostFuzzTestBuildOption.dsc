...
[BuildOptions]
  ...
  GCC:*_SUGARMILL_X64_CC_FLAGS == -m64 -g -fshort-wchar -fno-strict-aliasing -Wall -idirafter/usr/include -c -include $(DEST_DIR_DEBUG)/AutoGen.h
  GCC:*_SUGARMILL_X64_CC_FLAGS = "-DNO_MSABI_VA_FUNCS=TRUE"
  GCC:*_SUGARMILL_*_CC_FLAGS = -O1 -fPIC -shared -static "-DSUGARMILL=1" -Wno-incompatible-pointer-types
  GCC:*_SUGARMILL_*_DLINK2_FLAGS = -shared -static
